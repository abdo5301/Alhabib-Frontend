...
<template>
  <div>
    <header :class="[page_scrolled ? 'fixed_header' : 'default_header',route.path != '/' && route.path != '/en' ? 'border-b border-b-gray-300' : 'border-b-0', 'fixed w-full lg:hover:bg-white z-40']">
