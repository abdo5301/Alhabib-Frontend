<template>
  <div
    ...
    <NuxtLink :to="link" class="relative w-full" @click="triggerClickProduct(null)">
      <NuxtImg loading="lazy" width="318px" height="304px" quality="80" format="webp"
        :class="[list_type == 'solo' ? 'h-[377px]' : 'h-[160px]', 'w-full lg:h-[304px] rounded-lg object-cover']"
        :src="image ??= '/images/placeholder-logo.png'" :alt="name" placeholder="/images/image-loader.svg"
