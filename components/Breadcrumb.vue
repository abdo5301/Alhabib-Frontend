<template>
  <ol class="mt-[35px] lg:mt-[63px] mx-7 lg:gap-4 gap-[6px] flex items-center">
    <li class="flex items-center lg:gap-4 gap-[6px]">
      ...
      <svg v-if="lang.dir == 'rtl'" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
