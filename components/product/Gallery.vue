<template>
  <div class="lg:flex hidden relative container flex-col gap-12 justify-center items-center z-30 px-5">
    <!-- Slider -->
    <div id="product-carousel" class="hidden lg:block relative w-full ">
      <div class="relative overflow-hidden h-[888px]">
        <!-- Slider items -->
      ...
      <!-- Slider indicators -->
      <div class="relative z-30 flex justify-start gap-6 mt-5">
        <div class="w-[123px] h-[118px] cursor-pointer flex items-center" ref="indicatorRefs"
    ...
    <button id="product-slider-previous" type="button"
      class="absolute top-0 -left-7 z-30 flex items-center justify-center h-full cursor-pointer group focus:outline-none">
    ...
    <button id="product-slider-next" type="button"
      class="absolute top-0 -right-7 z-30 flex items-center justify-center h-full cursor-pointer group focus:outline-none">
      <span class="inline-flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="44" height="69" viewBox="0 0 44 69" fill="none">
          <path fill-rule="evenodd" clip-rule="evenodd"
